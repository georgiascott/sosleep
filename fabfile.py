"""
Starter fabfile for deploying the sosleep project.
...
# CHANGEME
env.hosts = ['user@sosleep.example.com']
env.code_dir = '/srv/www/sosleep'
env.project_dir = '/srv/www/sosleep/sosleep'
env.static_root = '/srv/www/sosleep/static/'
env.virtualenv = '/srv/www/sosleep/.virtualenv'
env.code_repo = 'git@github.com:user/sosleep.git'
env.django_settings_module = 'sosleep.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/sosleep/wsgi.py" % env.code_dir)
